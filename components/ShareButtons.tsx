  ...
  const platforms = [
    {
      name: 'X',
      Icon: XIcon,
      href: `https://twitter.com/intent/tweet?text=${encodedTitle}&url=${encodedUrl}&via=icesumeng`,
      ...
      <div className="flex flex-wrap items-center gap-2">
        {platforms.map(({ name, Icon, href, color }) => (
          <a
            ...
            className={`inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 text-sm font-medium text-gray-600 transition-all ${color}`}
          >
            <Icon />
            <span>{name}</span>
          </a>
